...
| `register_slot`                                    | Register slot                                                                           | integer                                                                                                                                                                                      | Usually has the same value as binding_slot                                                                               |
| `binding_slot`                                     | Binding slot                                                                            | integer                                                                                                                                                                                      | usually has the same value as register_slot                                                                              |
...
| `texture_format`                                   | Texture format                                                                          | Arbitrary string, possible values include (but not limited to): (empty string) `r32ui` `rg32ui` `rgba32ui` `r32f` `r16f` `rg16f` `rgba16f` `rgba8` `rg8` `r8` `rgba32f` `float` `int` `uint` | Possible values were extracted from [bgfx_compute.sh](https://github.com/bkaradzic/bgfx/blob/master/src/bgfx_compute.sh) |
...
| `slot_count`                                       | Number of consecutive slots used by this buffer (e.g. if it is an array of buffers)     | integer                                                                                                                                                                                      | All materials have it set to 1                                                                                           |
...
| `flag_domain`              | All possible values of every flag                           | Dictionary of lists of strings                                                                                                                                                        | The first flag value in every flag_domain array is the default value. A variant with such a default set of flags will be used by the game, if it fails to find a specific variant with a specific set of flags in the material |
| `output_binding_signature` | Unique ID for a specific set of framebuffer output bindings | integer                                                                                                                                                                               |                                                                                                                                                                                                                                |
